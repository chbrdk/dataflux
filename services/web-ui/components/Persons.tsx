...
import { User, Users, Eye, Calendar, Image as ImageIcon, ArrowLeft } from 'lucide-react'
...
const Persons: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Fehler: {personsError.message}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Persons Grid */}
      {persons && persons.persons && persons.persons.length > 0 ? (
